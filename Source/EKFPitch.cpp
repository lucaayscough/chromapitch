...
void EKFPitch::prepareToPlay(float sampleRate, int samplesPerBlock)
{
...
void EKFPitch::processBlock(juce::AudioBuffer<float>& buffer)
{
    ...
    for (int i = 0; i < bufferSize; i+=nUpdate)
    {
